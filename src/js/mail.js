function send(){
    ...
    if(!nome || !email || !assunto || !mensagem || !captcha){
        ...
        var url = "https://www.crimapp.ml/src/system/mail.php"; // server url
        r.open("POST", url ,true);
        r.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        r.send("nome=" + nome +"&email=" + email + "&assunto=" + assunto + "&mensagem="+ mensagem + "&g-recaptcha-response=" + captcha);
    }
}